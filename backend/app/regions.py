"""Static continent -> country list for the top-level region selector.

Cities are deliberately NOT enumerated here — the frontend's city
autocomplete is populated dynamically from whatever cities actually show
up in ingested leads (see /api/regions/cities in routers/leads.py).
"""
...
COUNTRY_TO_CONTINENT = {
    country: continent for continent, countries in CONTINENTS.items() for country in countries
}
